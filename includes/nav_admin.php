...
<nav>
    ...
    <div class="nav-links">
        <a href="/~DUMONT-Tom/trackInsi/admin/dashboard.php"
           class="<?= basename($_SERVER['PHP_SELF']) === 'dashboard.php' ? 'active' : '' ?>">
            📊 Dashboard
        </a>
        <a href="/~DUMONT-Tom/trackInsi/admin/incidents.php"
           class="<?= basename($_SERVER['PHP_SELF']) === 'incidents.php' ? 'active' : '' ?>">
            🔴 Incidents
        </a>
        <a href="/~DUMONT-Tom/trackInsi/admin/utilisateurs.php"
           class="<?= basename($_SERVER['PHP_SELF']) === 'utilisateurs.php' ? 'active' : '' ?>">
            👥 Utilisateurs
        </a>
    </div>
